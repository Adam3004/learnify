...
import static com.brightpath.learnify.exception.notfound.ResourceType.DOCUMENT_PAGE;
import static com.brightpath.learnify.exception.notfound.ResourceType.NOTE;
import static com.brightpath.learnify.exception.notfound.ResourceType.NOTE_PAGE;
...
public class NoteService {
    ...
    public String getBoardNoteContentPage(UUID uuid, Integer pageNumber) {
        ...
        return byNoteIdAndPageNumber.orElseThrow(() -> new ResourceNotFoundException(NOTE_PAGE));
    }
    ...
    public String getDocumentNoteContentPage(UUID uuid, Integer pageNumber) {
        ...
        return byNoteIdAndPageNumber.orElseThrow(() -> new ResourceNotFoundException(DOCUMENT_PAGE));
    }
}
